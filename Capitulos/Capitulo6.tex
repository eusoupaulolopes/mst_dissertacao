...
\begin{table}[h] \centering
	\caption{Expectativa de atendimento das solicitações durante um ciclo}
	\small
%	\tabcolsep=0.05cm
	...
	\begin{tabular}{ l c c c c c}
		...
		\midrule
		 no-throttling &Não & 30 sol\tnote{**} & 30 sol & 30 sol & 0 sol \\
		 fixed-throttling & Sim & 15 sol & 15 sol & 15 sol & 0 sol\\
		 dynamic-throttling & Sim & 30 sol & 22 sol & 15 sol & 0 sol\\
		
		\bottomrule 
	\end{tabular}
	\begin{tablenotes}\footnotesize
		\item[*] \textit{S} representa o percentual energético presente no \textit{Storage} no momento observado.
		\item[**] sol é a abreviação para solicitações, refere-se aos pedidos atendidos pelo dispositivo.
	\end{tablenotes}
\end{threeparttable}
